...
class GenericTrainingManager:
    ...
    def load_dataset(self):
        ...
        self.dataset = DatasetManager(self.params["dataset_params"],self.is_inference)
    ...
    def predict_custom(self, custom_name, sets_list, custom=False):
        ...
        with torch.no_grad():
            for ind_batch, batch_data in enumerate(t):
                ...
                batch_output = self.evaluate_batch_custom(batch_data)
    ...
    def load_save_info(self, info_dict):
        ...
        """
        if "curriculum_config" in info_dict.keys() and not self.is_inference:
